export const config = {
  ...
  USERS: [
    {
      ...
      id: "oP-1y6qP1LxDlUt7vrMVANCRBrCc",
      id: "oP-1y6nGuruShV7dyxrWog8pVhjI",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "fGaydYlhU-mTTeYAqY5x6IqIXoulmK9njW53WgY2nNQ",
      // 所在省份
      province: "河北",
      // 所在城市
      city: "石家庄",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "涵姐", "year": "2022", "date": "04-14"},
        {"type": "生理期", "name": "涵姐", "year": "2021", "date": "09-25"},
      ],
  ...
  SLOT_LIST: [
    ...
    {"keyword": "lover_prattle", contents: [
      ...
      "何以解忧，唯有暴···抱抱你",
      "不要抱怨，麻烦请抱我。",
      "我得给你买个指南针，避免你被我惯得找不到北了",
      "我身体很好，可以扛米袋，扛煤气罐。可我怎么就扛不住想你呢",
      "我今天去买油了，你猜什么油，I LOVE YOU",
      "其实我每天只想你一次。虽然很少，，，但那是因为一想就是一整天啊💞",
    ]},
    // 你可以不断按格式往下增加
    // ...
  ],
